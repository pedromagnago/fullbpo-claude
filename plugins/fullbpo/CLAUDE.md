...
- **Skills:** `metodo-fullbpo`, `voz-da-marca`, `nomenclatura-full`, `assistir-video` (transcreve/analisa vídeo de referência frame a frame) e `estudo-de-video` (relatório HTML de estudo de vídeo + perfil para o cliente).
