...
- **4 skills** — método (`metodo-fullbpo`), voz da marca (`voz-da-marca`), nomenclatura (`nomenclatura-full`) e `assistir-video` (assiste/transcreve vídeos — Reel, YouTube, WhatsApp — que chegam na operação, 100% local).
...
└── plugins/fullbpo/
    ...
    ├── skills/                          → skills (método + utilitárias)
